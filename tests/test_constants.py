...
class TestOpenShiftOperatorInstallManifest:
    ...
    def test_resolve_dependencies(self):
        ...
        assert resolved.index("openshift-cert-manager-operator") < resolved.index(
            "kueue-operator"
        )
...
class TestManifestGeneration:
    ...
    def test_get_dsci_manifest_custom(self):
        ...
        assert (
            "managementState: Managed" in manifest
        )  # kserve_raw=False means serviceMesh is Managed
    ...
    def test_get_dsci_manifest_raw_serving(self):
        ...
        assert (
            "managementState: Removed" in manifest
        )  # kserve_raw=True means serviceMesh is Removed
