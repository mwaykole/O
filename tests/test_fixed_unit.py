...
class TestMainFunctionProperlyMocked:
    ...
    @patch("time.time")
    def test_main_cleanup_and_install_mocked(
        self, mock_time, mock_install, mock_cleanup
    ):
    ...
    def test_core_module_imports(self):
        ...
        assert all(
            [
                ...
                rhoshift.cli,
                rhoshift.cli.args,
                rhoshift.cli.commands,
                rhoshift.utils,
                rhoshift.utils.constants,
                rhoshift.utils.operator,
                rhoshift.utils.operator.operator,
                rhoshift.utils.operator.enhanced_operator,
                rhoshift.logger,
            ]
        )
